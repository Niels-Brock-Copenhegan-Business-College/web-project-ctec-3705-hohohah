...
<div class="admin-content">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;flex-wrap:wrap;">
    <section aria-labelledby="quick-actions-heading">
      <h2 id="quick-actions-heading" style="font-size:1.1rem;font-weight:700;color:var(--primary);margin-bottom:1rem;">Quick Actions</h2>
      <div style="display:flex;flex-direction:column;gap:0.75rem;">
        <a href="<?= url('/admin/programmes/create') ?>" class="btn btn-primary">&#43; Add New Programme</a>
        <a href="<?= url('/admin/modules/create') ?>" class="btn btn-outline">&#43; Add New Module</a>
        <a href="<?= url('/admin/mailing-list') ?>" class="btn btn-outline">&#128203; View Mailing List</a>
        <a href="<?= url('/admin/mailing-list/export') ?>" class="btn btn-success">&#8659; Export CSV</a>
      </div>
    </section>

    <section aria-labelledby="recent-heading">
      <h2 id="recent-heading" style="font-size:1.1rem;font-weight:700;color:var(--primary);margin-bottom:1rem;">Recent Registrations</h2>
      <?php if (empty($recentRegistrations)): ?>
      <p style="color:var(--text-muted);font-size:0.9rem;">No registrations yet.</p>
      <?php else: ?>
      ...
      <a href="<?= url('/admin/mailing-list') ?>" style="font-size:0.85rem;color:var(--primary);margin-top:0.75rem;display:inline-block;">View all &rarr;</a>
      <?php endif; ?>
    </section>
  </div>
</div>
